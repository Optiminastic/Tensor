...
const COLUMNS = ['Job', 'Description', 'Qty', 'Assembly', 'Customer', 'Created']
...
/** Jobs ready for QC - status = completed, assembly done or not required,
 * qc_status = pending (see the QC/Packaging page's "Pending QC" tab). */
export function QcQueueTable({ brand, jobs }: QcQueueTableProps): JSX.Element {
  return (
    <Card>
      <Table>
        <TableHead>
